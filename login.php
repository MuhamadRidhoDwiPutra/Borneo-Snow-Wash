...
<head>
	...
	<title>Login Admin - Borneo Snow Wash</title>
	...
	<div id="container" data-background="res/img/bg.jpg">
		<div class="box box-sm">
			<div class="logo">
				...
				<h1 style="font-size:32pt;letter-spacing:-4px;"><span style="color:#32b2e9
"> Borneo </span> Snow Wash</h1>
			...
			<div class="form">
				<form action="proses_login.php" method="post">
					...
					<button class="btn btn-block" style="color:#32b2e9">Login</button>
