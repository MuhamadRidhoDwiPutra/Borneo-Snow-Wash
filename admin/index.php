...
<head>
    ...
    <title>Admin Panel - Borneo Snow Wash</title>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="index.php?p=pendaftaran"> <i class="menu-icon ti-list"></i>Data Riwayat Cucian </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="index.php?p=type_kendaraan"> <i class="menu-icon ti-list"></i>Type Kendaraan </a>
                    </li>
        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    ...
                    <img class="logo-img" src="../images/borneopng.png" alt="Logo" style="width:15%">
                </div>
            </div>
        </header>
